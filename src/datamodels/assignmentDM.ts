...
export default class AssignmentDM extends Datamodel {
  ...
  @JsonProperty("nuggetNumber", NuggetNumberConverter, true) nuggetNumber: string | undefined = undefined;
  @JsonProperty('projectNumber', ProjectNumberConverter, true) projectNumber: string | undefined = undefined;
