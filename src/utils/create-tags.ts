...
export const createClasses = (tag, tags?, validation = [], customDuplicateFn?) => {
 ...
 */
export const createTag = (tag, ...rest) => {
 ...
 */
export const createTags = (tags, ...rest) => tags.map(t => createTag(t, tags, ...rest));
