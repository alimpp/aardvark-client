<template>
    <div id="GoodNewsScrum" class="max-height-moduletab-content">
        <CoreTable
                :loading="$wait.is(waitState.ACTION_GOODSCRUM_LOADING)"
...
<script lang="ts">
    ...
    import {ApplicationDSModule, GoodNewsScrumCSModule} from "@/store"
    ...
    export default class GoodNewsScrum extends TableSubModule {
        ...
        get moduleTabName(): ModuleTabName{
            return ModuleTabName.goodNewsScrum
        }

        //Overriding Parent Method
        get dataSource(): TableCS<TableRow> {
            return GoodNewsScrumCSModule
        }
