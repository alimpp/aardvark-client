<template>
    <div id="LeadOverdueTimecard" class="max-height-moduletab-content">
        <CoreTable
                :loading="$wait.is(waitState.ACTION_LEADOVERDUETIMECARD_LOADING)"
...
<script lang="ts">
    ...
    import {ApplicationDSModule, LeadOverdueTimecardCSModule} from "@/store"
    ...
    export default class LeadOverdueTimecard extends TableSubModule {
        ...
        get moduleTabName(): ModuleTabName{
            return ModuleTabName.leadOverdueTimecard
        }

        //Overriding Parent Method
        get dataSource(): TableCS<TableRow> {
            return LeadOverdueTimecardCSModule
        }
