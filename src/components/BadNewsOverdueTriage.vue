<template>
    <div id="BadNewsOverdueTriage" class="max-height-moduletab-content">
        <CoreTable
                :loading="$wait.is(waitState.ACTION_BADNEWSOVERDUETRIAGE_LOADING)"
...
<script lang="ts">
    ...
    import {ApplicationDSModule, BadNewsOverdueTriageCSModule} from "@/store"
    ...
    export default class BadNewsOverdueTriage extends TableSubModule {
        ...
        get moduleTabName(): ModuleTabName{
            return ModuleTabName.badNewsOverdueTriage
        }

        //Overriding Parent Method
        get dataSource(): TableCS<TableRow> {
            return BadNewsOverdueTriageCSModule
        }
