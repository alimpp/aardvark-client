<template>
  <div class="d-flex w-100" :class="{'flex-row-reverse': isMine}">
    ...
    <MessageBubble class="bubble" :message="message">
      ...
      <MessageImage width="100%" minWidth="250px" :message="message" />
...
@Component({
  ...
  components: {MessageBubble, MessageAvatar, MessageUsername, MessageTimestamp, MessageOptions, MessageContent, MessageSeen, MessageImage, MessageRetry, MessageReply, MessageSyncing}
})
export default class ChatImageMessage extends BaseChatMessage {
