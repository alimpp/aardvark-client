...
import MessageAudio from '@/components/Chat/MessageComponents/MessageAudio.vue';
...
@Component({
  name: "ChatAudioMessage",
  components: {MessageBubble, MessageAvatar, MessageUsername, MessageOptions, MessageReply, MessageContent, MessageRetry, MessageSyncing, MessageSeen, MessageTimestamp, MessageAudio}
})
export default class ChatAudioMessage extends BaseChatMessage {
  get actions() {
