<template>
  <RoomContainer class="h-100">
    <RoomMessages :store="store" />
  </RoomContainer>
</template>

<script lang="ts">
import {Component} from "vue-property-decorator";
import {AttachmentLinkCSModule} from "@/store";
...
@Component({
  name: "AttachmentLinkRoom",
  components: {RoomContainer, RoomMessages}
})
export default class AttachmentLinkRoom extends BaseRoom {

  get store() {
    return AttachmentLinkCSModule;
  }
