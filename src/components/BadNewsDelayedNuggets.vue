<template>
    <div id="BadNewsDelayedNuggets" class="max-height-moduletab-content">
        <CoreTable
                :loading="$wait.is(waitState.ACTION_BADNEWSDELAYEDNUGGETS_LOADING)"
...
<script lang="ts">
    ...
    import {ApplicationDSModule, BadNewsDelayedNuggetsCSModule} from "@/store"
    ...
    export default class BadNewsDelayedNuggets extends TableSubModule {
        ...
        get moduleTabName(): ModuleTabName{
            return ModuleTabName.badNewsDelayedNuggets
        }

        //Overriding Parent Method
        get dataSource(): TableCS<TableRow> {
            return BadNewsDelayedNuggetsCSModule
        }
